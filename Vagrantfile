...
Vagrant::Config.run do |config|
    config.vm.define :laravel4 do |lv4_config|
        ...
        lv4_config.vm.share_folder("www", "/var/www", "../src", :mount_options => ["dmode=777","fmode=777"])
        lv4_config.vm.provision :shell, :inline => "echo \"America/Chicago\" | sudo tee /etc/timezone && dpkg-reconfigure --frontend noninteractive tzdata"
